...
hum.true.AR <- -EHUM(beta[1:(d-1)], sim, d)
hum.true.AR
...
df.beta <- data.frame(beta=beta, EHUM.mean=apply(beta.ehum.bf, 1, mean), 
                      ...
                      PMNA.mean=apply(beta.ehum.bf, 1, mean), 
                      EHUM.bias=apply(beta.ehum.bf, 1, mean)-beta, PMNA.sd=apply(beta.ehum.bf, 1, sd),
...
filename <- paste0("result_normal_AR_d3_", 3, ".RData")
